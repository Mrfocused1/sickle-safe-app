    ...
    return (
        <View className="flex-1 bg-gray-50">
            <ScrollView showsVerticalScrollIndicator={false} className="flex-1">
                ...
                {/* Header Section */}
                <View className="bg-white px-6 pb-6 rounded-b-[40px] shadow-sm border-b border-gray-100" style={{ paddingTop: insets.top + 10 }}>
                    ...
                    <View className="bg-white rounded-[32px] p-6 shadow-sm border border-gray-100">
                        <View className="flex-row justify-between items-start mb-6">
                            <View className="flex-row items-center">
                                <View className="w-12 h-12 rounded-full border border-gray-100 overflow-hidden mr-3">
                                    <Image
                                ...
                                <View>
                                    <Text className="text-gray-900 font-bold text-lg">Maya Thompson</Text>
                            ...
                            <Pressable
                                onPress={() => handleAction('Call Maya')}
                        ...
                        <View className="flex-row gap-3">
                            <View className="flex-1 bg-gray-50 rounded-2xl p-3 border border-gray-100">
                                <View className="flex-row items-center mb-2">
                                    ...
                                    <Text className="text-gray-400 text-[10px] font-bold uppercase">Pain Lvl</Text>
                                </View>
                            ...
                            <View className="flex-1 bg-gray-50 rounded-2xl p-3 border border-gray-100">
                                <View className="flex-row items-center mb-2">
                                    ...
                                    <Text className="text-gray-400 text-[10px] font-bold uppercase">Hydration</Text>
                                </View>
                            ...
                            <View className="flex-1 bg-gray-50 rounded-2xl p-3 border border-gray-100">
                                <View className="flex-row items-center mb-2">
                                    ...
                                    <Text className="text-gray-400 text-[10px] font-bold uppercase">Vitals</Text>
                                </View>
                ...
                <View className="px-6 mb-8">
                    ...
                    <View className="bg-white rounded-[32px] p-5 shadow-sm border border-gray-100">
                        {RECENT_ACTIVITY.map((item, index) => (
                            <Pressable
                                key={item.id}
                                onPress={() => handleAction('Activity Detail')}
                                className={`flex-row items-center py-3 ${index !== RECENT_ACTIVITY.length - 1 ? 'border-b border-gray-50' : ''}`}
                            >
                                ...
                                <View className="flex-1">
                                    ...
                                    <Text className="text-gray-500 text-xs mt-0.5">{item.detail}</Text>
                                </View>
